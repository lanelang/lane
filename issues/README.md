...
| --- | ---: | --- | --- | --- | --- |
| [ISS-393](ISS-393.md) | 1 | bug | unassigned | Preserve generic nominal contracts in representation workers | area/lanec, area/runtime-anf, area/physical-lowering, effects, generics, representation, tests, agent |

## Unresolved Issues

| ID | Status | Priority | Type | Assignee | Blocked by | Blocks | Title |
| --- | --- | ---: | --- | --- | --- | --- | --- |
| [ISS-393](ISS-393.md) | open | 1 | bug | unassigned | none | none | Preserve generic nominal contracts in representation workers |
