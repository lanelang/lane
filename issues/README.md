...
| --- | ---: | --- | --- | --- | --- |
| [ISS-140](ISS-140.md) | 1 | feature | unassigned | Add Basic Double special constants | area/basic, area/runtime, area/examples, agent |

## Unresolved Issues

| ID | Status | Priority | Type | Assignee | Blocked by | Blocks | Title |
| --- | --- | ---: | --- | --- | --- | --- | --- |
| [ISS-140](ISS-140.md) | open | 1 | feature | unassigned | none | none | Add Basic Double special constants |
