...
6. the Layout Recipe, Object Shape, and String Constant tables.
...
ADR 0129 raises `linked_program_schema_version` to 10. A loader rejects older
...
- Linked-program schema version 10 identifies the current persisted bytecode payload.
