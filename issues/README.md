...
| --- | ---: | --- | --- | --- | --- |
| [ISS-197](ISS-197.md) | 1 | epic | unassigned | Separate built-in Io, compiler intrinsics, and extern host calls | ready-for-agent, area/effects, area/runtime, area/lanec, area/loisvm, area/basic, area/artifacts, architecture |

## Unresolved Issues

| ID | Status | Priority | Type | Assignee | Blocked by | Blocks | Title |
| --- | --- | ---: | --- | --- | --- | --- | --- |
| [ISS-197](ISS-197.md) | open | 1 | epic | unassigned | none | none | Separate built-in Io, compiler intrinsics, and extern host calls |
