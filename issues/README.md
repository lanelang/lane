...
| [ISS-286](ISS-286.md) | 1 | bug | unassigned | Rewrite every reference when effect specialization copies a type | area/effect-specialization, correctness, agent |
...
| [ISS-284](ISS-284.md) | open | 0 | task | unassigned | ISS-286 | none | Verify the lowered program and accept subeffects where a value is consumed |
| [ISS-280](ISS-280.md) | open | 1 | bug | unassigned | none | none | Bound Wasm control-flow nesting by program structure |
| [ISS-286](ISS-286.md) | open | 1 | bug | unassigned | none | ISS-284 | Rewrite every reference when effect specialization copies a type |
