...
| --- | ---: | --- | --- | --- | --- |
| [ISS-047](ISS-047.md) | 1 | task | unassigned | Validate Lane handler checking end to end | area/lanec, area/effects, tests, agent |
...
| [ISS-041](ISS-041.md) | open | 1 | epic | unassigned | ISS-047 | ISS-037 | Complete Lane handler checking and payload pattern lowering |
| [ISS-047](ISS-047.md) | open | 1 | task | unassigned | none | ISS-041 | Validate Lane handler checking end to end |
