...
| --- | ---: | --- | --- | --- | --- |
| [ISS-414](ISS-414.md) | 2 | task | unassigned | Reduce ARC and unwind expansion from verified lifetime plans | area/lanec, area/vmcfg, area/wasm, area/arc, optimization, code-size, tests, agent |

## Unresolved Issues

| ID | Status | Priority | Type | Assignee | Blocked by | Blocks | Title |
| --- | --- | ---: | --- | --- | --- | --- | --- |
| [ISS-414](ISS-414.md) | open | 2 | task | unassigned | none | none | Reduce ARC and unwind expansion from verified lifetime plans |
