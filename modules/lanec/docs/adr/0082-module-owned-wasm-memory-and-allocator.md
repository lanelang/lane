...
- Restricted runtime services may allocate while ordinary Lane execution is paused; a service is exported only when a retained host-import result requires it and its static layout is present.
