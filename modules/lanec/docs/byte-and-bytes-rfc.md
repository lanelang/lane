...
- both defensively reject invalid length and index operands without publishing a partial owner;
- resource exhaustion and allocation failure use the existing fatal runtime failure boundary.
