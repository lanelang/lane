...
| --- | ---: | --- | --- | --- | --- |
| [ISS-283](ISS-283.md) | 0 | task | unassigned | Make CPS function types effect-polymorphic in the handler residual | area/effect-lowering, area/cps, area/core-opt, correctness, architecture, design-review, agent |
...
| [ISS-283](ISS-283.md) | open | 0 | task | unassigned | none | none | Make CPS function types effect-polymorphic in the handler residual |
