...
| --- | ---: | --- | --- | --- | --- |
| [ISS-035](ISS-035.md) | 1 | task | unassigned | Add Buslane verifier rules for effects and handlers | area/buslane, area/effects, area/verifier, tests, agent |

## Unresolved Issues

| ID | Status | Priority | Type | Assignee | Blocked by | Blocks | Title |
| --- | --- | ---: | --- | --- | --- | --- | --- |
| [ISS-035](ISS-035.md) | open | 1 | task | unassigned | none | ISS-036, ISS-037 | Add Buslane verifier rules for effects and handlers |
